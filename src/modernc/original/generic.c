...
{
	if (argc > 1) {
		printf("testing strto functions: base 10 = %lu, general base = "
		       "%llu\n",
	...
	puts((memcpy)((volatile char[6]){ 0 }, "he1lo", 6));
	// Erroneous use of target buffer, using 6 where there are only 5.
	// diagnostic?

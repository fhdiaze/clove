...
int main(int argc, char *argv[argc + 1])
{
	...
	test(is_const_target((const char *)nullptr));
	test(is_const_target((volatile char *)nullptr));
	test(is_const_target((const volatile char *)nullptr));
	test(is_volatile_target((char *)nullptr));
	test(is_volatile_target((const char *)nullptr));
	test(is_volatile_target((volatile char *)nullptr));
	test(is_volatile_target((const volatile char *)nullptr));
	test(is_const((char){ 0 }));
	test(is_const((const char){ 0 }));
	test(is_const((volatile char){ 0 }));
	test(is_const((const volatile char){ 0 }));
	test(is_volatile((char){ 0 }));
	test(is_volatile((const char){ 0 }));
	test(is_volatile((volatile char){ 0 }));
	test(is_volatile((const volatile char){ 0 }));
	...
	test(isvla(char (*)[1][1]));
	test(isvla(char (*)[(int){ 1 }][1]));
	test(is_pointer_nvla((const volatile char[]){ 0 }));
	test(is_pointer_nvla((const volatile char *){ 0 }));
	...
	test(is_pointer_vla(&vla));
	test(is_pointer_vla(*(&vla)));
	test(is_pointer((const volatile char[]){ 0 }));
	test(is_pointer((const volatile char *){ nullptr }));
	...
	test(is_pointer(&vla));
	test(is_pointer(*(&vla)));
	test(is_fla((const volatile char[]){ 0 }));
	test(is_fla((const volatile char *){ 0 }));
	test(is_fla(fla));
	test(is_fla(fla[0]));
	test(is_fla(&fla));
	...
	test(is_fla(&vla));
	test(is_fla(*(&vla)));
	test(is_array((const volatile char[]){ 0 }));
	test(is_array((const volatile char *){ 0 }));
	test(is_array(fla));
	test(is_array(fla[0]));
	test(is_array(&fla));

...
int main(int argc, [[maybe_unused]] char *argv[argc + 1])
{
	...
	// exact
		...
		printf(
		    "value of (double)5²¹⋅(double)5⁻²¹ as decimal\t\t%.40e\n",
		    p2);
		...
		printf("equality of roundtrip (double)5⁻²¹ through "
	               "decimal:\t\t\t\t\t%s\n",
		...
		printf("equality of roundtrip (_Decimal64)5²¹⋅(_Decimal64)5⁻²¹ "
	               "through "
	               "binary:\t\t\t%s\n",

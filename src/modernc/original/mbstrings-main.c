 ...
 **/
void draw_sep(const char start[static 1], const char end[static 1])
{
	fputs(start, stdout);
...
int main(void)
{
	...
	const char *locC_ = setlocale(LC_CTYPE, 0);
	...
	const char *locLoc_ = setlocale(LC_CTYPE, 0);
	char locLoc[strlen(locLoc_) + 1];
	strcpy(locLoc, locLoc_);
	const char strhello[] = "Hä\u0131łłö";
	const char u8hello[] = u8"Hä\u0131łłö";
	const wchar_t wcshello[] = L"Hä\u0131łłö";
	const char strvowel[] = "aeiouäëïöüáéíóúàèìòùæœ\u0131";
	const char u8vowel[] = u8"aeiouäëïöüáéíóúàèìòùæœ\u0131";
	const wchar_t wcsvowel[] = L"aeiouäëïöüáéíóúàèìòùæœ\u0131";
